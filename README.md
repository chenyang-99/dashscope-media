...
```bash
pi install git:github.com/<你的用户名>/dashscope-media
```
...
```bash
# 安装到 pi
skill.sh install pi https://github.com/<你的用户名>/dashscope-media

# 或使用 npx skills CLI
npx skills add <你的用户名>/dashscope-media --skill dashscope-media
```
